...
<html lang="en">
  <head>
    ...
    <title>Regalos DiQSi | Home</title>
    ...
    <link href='https://fonts.googleapis.com/css?family=Raleway' rel='stylesheet' type='text/css'>
     ...
     <script src="https://kit.fontawesome.com/673dd11d4c.js" crossorigin="anonymous"></script>
              ...
              <div class="aa-logo">
                ...
                <a href="index.html">
                 <span> <i class="fas fa-shopping-cart"></i></span>
                  <p>Di Q' Si <strong> ...con amor</strong> <span>Expresiones y Detalles</span></p>
                </a>
                <!-- img based logo -->
        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="#">Administrar Productos<span></span></a>
                 <li><a href="#">Administrar Pedidos</a></li>   
                  <li><a href="#">Administrar Clientes</a></li> 
                <!--<ul class="dropdown-menu">                
                  <li><a href="#">Arreglos Florales</a></li>
                  <li><a href="#">Portaretratos y Cuadros</a></li>
                  <li><a href="#">Globos Confetti</a></li>
                  <li><a href="#">Jarros y Vasos</a></li>
                  <li><a href="#">Peluches</a></li>
                  <li><a href="#">Chocomensajes</a></li>
                  <li><a href="#">Pulseras y Accesorios</a></li>
                  <li><a href="#"></a></li>
                </ul>-->
              </li>
              <li><a href="#">Publicar Ofertas <span></span></a>
               <!-- <ul class="dropdown-menu">                
                  <li><a href="#">Camisetas</a></li>
                  <li><a href="#">Protectores de celulares</a></li>
                  <li><a href="#">Almohadas</a></li>                                                
                  <li><a href="#">Accesories</a></li>                
                </ul>-->
              </li>  
              <li><a href="#">Administrar Datos Contacto</a></li>
