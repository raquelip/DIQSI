          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-search-box">
                <form action="">
                  <input type="text" name="" id="" placeholder="Search here ex. 'arreglos florales' ">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="#">Tipos de regalos <span class="caret"></span></a>
                <ul class="dropdown-menu">                
                  ...
                  <li><a href="#">Jarros y Vasos</a></li>                                    <li><a href="#">Peluches</a></li>
                  <li><a href="#">Chocomensajes</a></li>
                  <li><a href="#">Accesorios</a></li>
                </ul>
              </li>
              <li><a href="#">Detalles Personalizados <span class="caret"></span></a>
                <ul class="dropdown-menu">  
                  <li><a href="#">Camisetas</a></li>                                         <li><a href="#">Protectores de celulares</a></li>              
